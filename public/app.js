...
let allCountriesData=[];//variable almacenará todos los datos de los países.
...
function initialize(){
    ...
    fetch(BASE_URL)
        ...
        clearInterval(timerInterval);//Por si hay un intervalo previo corriendo, lo limpio
...
function showResults(){
    ...
    document.getElementById('restartBtn').addEventListener('click', function() {
        ...
        document.getElementById('rankingTableContainer').setAttribute('hidden', true);
